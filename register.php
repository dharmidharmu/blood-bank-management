...
$status=1;
$sql="INSERT INTO  register(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Password,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:password,:status)";
...
<header id="header" class="skel-layers-fixed">
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Register <small>Here</small></h1>
